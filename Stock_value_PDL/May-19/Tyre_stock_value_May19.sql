...
EXEC SP_ITEM_STOCK_TYRE_REPORT('01-May-2019', '31-May-2019', NULL, NULL, NULL, NULL);
...
--Create table STOCK_VALUE_TYRE_MAY_19
--AS SELECT * FROM STOCK_VALUE_TYRE_MAY_19;


DELETE FROM STOCK_VALUE_TYRE_MAY_19;

INSERT INTO STOCK_VALUE_TYRE_MAY_19(ITEM_CODE,ITEM_SHORT_DESC, LOC_CODE, OP_QTY, PUR_QTY, SALES_QTY, SALES_RETURN_QTY, CLOSE_QTY)
...
MERGE INTO STOCK_VALUE_TYRE_MAY_19
USING 
(
SELECT OP_DATE,F_DATE,T_DATE,LOC_CODE,LOCATION_DESC,BRAND_ID
,BRAND_NAME,BATERY_CAT_ID,ITEM_CATEGORY,ITEM_CODE
...
,PR_QTY+OP_RCVD_QT+OP_RT_QTY+OP_PR_QTY-OP_ISSUED_QTY-OP_RP_QTY-OP_GIFT_QTY-OP_ADJ+RCVD_QTY+IDT_QTY+RT_QTY-ISSUED_QTY-GIFT_QTY-ADJ_ISSUED_QTY-RP_QTY BAL_QTY
FROM TEMP_ITEM_STOCK_BAT_FOR_NET
) PURC ON (STOCK_VALUE_TYRE_MAY_19.ITEM_CODE = PURC.ITEM_CODE)
WHEN MATCHED THEN
UPDATE SET
   OP_QTY = PURC.OP_BAL
...
AND LP_PURCHASE_MASTER.PURCHASE_DATE BETWEEN '01-May-2019' AND '31-May-2019'
...
MERGE INTO STOCK_VALUE_TYRE_MAY_19
USING (SELECT * FROM STOCK_VALUE_TYRE_APR_19)
ST ON (STOCK_VALUE_TYRE_MAY_19.ITEM_CODE = ST.ITEM_CODE )
WHEN MATCHED THEN
UPDATE SET
...
UPDATE STOCK_VALUE_TYRE_MAY_19
