EXEC SP_IPS_ITEM_STOCK_LOC_WISE ('01-JUN-2019','30-JUN-2019',NULL,NULL,'004',NULL,'N');
...
--Create table STOCK_VALUE_IPS_MACHINE_JUN_19
--AS SELECT * FROM STOCK_VALUE_TYRE_JUN_19;


DELETE FROM STOCK_VALUE_IPS_MACHINE_JUN_19;



INSERT INTO STOCK_VALUE_IPS_MACHINE_JUN_19(ITEM_CODE,ITEM_SHORT_DESC, LOC_CODE, OP_QTY, PUR_QTY, SALES_QTY, SALES_RETURN_QTY, CLOSE_QTY)
...
SELECT * FROM STOCK_VALUE_IPS_MACHINE_JUN_19;
...
AND LP_PURCHASE_MASTER.PURCHASE_DATE BETWEEN '01-Jun-2019' AND '30-Jun-2019'
...
UPDATE SET
   ...
   MERGE INTO STOCK_VALUE_IPS_MACHINE_JUN_19
USING (SELECT * FROM STOCK_VALUE_IPS_MACHINE_MAY_19)
ST ON (STOCK_VALUE_IPS_MACHINE_JUN_19.ITEM_CODE = ST.ITEM_CODE )
WHEN MATCHED THEN
UPDATE SET
...
UPDATE STOCK_VALUE_IPS_MACHINE_JUN_19
...
SELECT *
FROM STOCK_VALUE_IPS_MACHINE_JUN_19
WHERE 1=1
