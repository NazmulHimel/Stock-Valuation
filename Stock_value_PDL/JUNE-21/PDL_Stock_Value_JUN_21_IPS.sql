CREATE TABLE STOCK_VALUE_IPS_ITEM_060721
AS SELECT * FROM STOCK_VALUE_IPS_ITEM;

EXEC SP_STOCK_VALUE_IPS_NET ('202106',1);


-- PDL_Stock_Value_JUN_21_IPS
SELECT ITM.ITEM_ID, ITM.ITEM_SHORT_DESC ITEM_NAME
, RATE_PREV RATE_MAY_21
, OPEN_QTY, OPEN_VALUE
, OPEN_QTY_DAMAGE
, OPEN_VALUE_DAMAGE
, PURCHASE_QTY
